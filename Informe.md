...
![alt text](<images/pre-reto/ejecutandose localmente.png>)
## Realizando un curl a dirección de la aplicación
![alt text](<images/pre-reto/ejecuin del get.png>)
## Realizando el comando npm test
![alt text](<images/pre-reto/ejecucion test.png>)
# Reto#1
...
![alt text](<images/reto1/fallo inicial npm test.png>)
## Captura o registro que compare la respuesta real de la aplicación con la expectativa del test.
![alt text](<images/reto1/comparacion aplicacion con el test.png>)
## Captura o registro del archivo de prueba corregido.
![alt text](<images/reto1/archivs test corregido.png>)
## Captura o registro de npm test ejecutándose correctamente después del ajuste.
![alt text](<images/reto1/npm test respondiendo bien.png>)

# Reto#2

## Captura o registro de la construcción inicial de la imagen.
![alt text](<images/reto2/(captura 2)imagen de docker sin modificar.png>)
## Captura o registro que muestre si el build inicial valida o no las pruebas.
![alt text](<images/reto2/(primera captura)imagen inicial docker sin modifcar nada.png>)
## Captura o registro del Dockerfile final.
![alt text](<images/reto2/(captura 3) docker corregido.png>)
## Captura o registro de un build bloqueado cuando existe una prueba fallida.
![alt text](<images/reto2/(captura 4) docker bloqueando la creacion de la imagen.png>)
## Captura o registro de un build exitoso cuando las pruebas pasan.
![alt text](<images/reto2/docker dejando pasar con la prueba.png>)
## Captura o registro del contenedor final respondiendo desde la máquina anfitriona.
![alt text](<images/reto2/(captura 5) corriendo desde docker pagina.png>)
